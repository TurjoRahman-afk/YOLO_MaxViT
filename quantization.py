...
# calibration_data_reader must be a CalibrationDataReader instance providing calibration data
# Example: calibration_data_reader = MyCalibrationDataReader(calibration_dataset_path)
calibration_data_reader = None  # TODO: replace with a proper CalibrationDataReader instance
