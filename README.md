...
> ⏳ Training in progress (210/300 epochs complete) — table will be updated as training continues.
...
| **YOLO-MaxViT (ours)** | COCO 20K subset | 210 / 300 | **0.401** | **0.263** | 🔄 In Progress |
