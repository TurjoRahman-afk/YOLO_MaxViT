...
> ⏳ Training in progress (270/300 epochs complete) — table will be updated as training continues.
...
| **YOLO-MaxViT (ours)** | COCO 20K subset | 270 / 300 | **0.405** | **0.263** | 🔄 In Progress |
